  ...
  return (
    <div className="w-full h-full bg-white rounded-[32px] p-[24px] flex flex-col gap-y-[16px]">
      <div className="grid grid-cols-4 gap-3">
        ...
        <div className="w-full h-auto  grid grid-cols-1 grid-rows-4  px-[20px]">
          <div className="w-full h-auto ">
            <div className="w-full h-auto flex justify-between">
              <div className="w-full h-auto ">
                <p className="justify-start text-black text-sm font-semibold font-['Poppins']">
                  Low
                </p>
                <p className="justify-start text-[#4d4d4d] text-base font-normal font-['Poppins']">
                  $2,56
                </p>
              </div>
              <div className="justify-start text-black text-xs font-semibold font-['Poppins']">
          ...
          <div className="h-auto">
            <input
              type="range"
              value={90}
              className="w-full h-2 bg-gray-300 rounded-full appearance-none cursor-pointer accent-red-500"
            />
          </div>
          ...
          <div className="w-full h-auto flex justify-between">
            <div className="justify-start text-black text-xs font-semibold font-['Poppins']">
              ...
              <p className="justify-start text-black text-base font-normal font-['Poppins']">
                $2,56
              </p>
            </div>
            <div className="justify-start text-black text-xs font-semibold font-['Poppins']">
