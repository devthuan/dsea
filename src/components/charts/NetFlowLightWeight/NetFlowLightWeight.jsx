...
// const tradeData = [
//   { time: "2024-03-25", type: "buy" },
//   { time: "2024-03-26", type: "sell" },
//   { time: "2024-03-27", type: "buy" },
//   { time: "2024-03-28", type: "sell" },
// ];

const NetFlowLightWeight = ({
  dataPrice = [],
  dataVolume = [],
  tradeData = [],
}) => {
  ...
  useEffect(() => {
    ...
    const netFlowSeries = chart.addSeries(HistogramSeries, {
      color: "#26a69a",
      priceFormat: {
        type: "volume",
      },
    ...
    netFlowSeries.priceScale().applyOptions({
      scaleMargins: {
        top: 0.6,
        bottom: 0.03,
      },
    ...
    lineSeries.setData(dataPrice);
    netFlowSeries.setData(dataVolume);
    ...
    chart.subscribeCrosshairMove((param) => {
      ...
      const volumeDataPoint = param.seriesData.get(netFlowSeries);
      if (volumeDataPoint) {
...
export default NetFlowLightWeight;
